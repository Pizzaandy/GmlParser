function GmlParser(_code, _tab_width = 4) constructor {
	...
	static document = function() {
		...
		return new Document(_start.start_index, accepted.end_index, statements);
	};
	...
	static block = function() {
		...
		return new Block(_start.start_index, accepted.end_index, _statements);
	};
	...
	static function_declaration = function() {
		...
		if (accept(GmlTokenKind.COLON)) {
			...
			var _parent_name = new Identifier(
			...
			_constructor_clause = new ConstructorClause(
				_start.start_index,
				accepted.end_index,
				_parent_name,
				_parent_args
	...
	static assignment_or_expression_statement = function() {
		...
		if (
            ...
            if (
                (is_instanceof(_lhs, UnaryExpression) && (_lhs.operator == "++" || _lhs.operator == "--")) 
                || is_instanceof(_lhs, CallExpression)
            ) {
                return _lhs;
            }
            ...
            return new AssignmentExpression(_start.start_index, accepted.end_index, _assignment_operator, _lhs, _rhs);
        }
	};
    ...
    static variable_declaration = function() {
        ...
        return new VariableDeclaration(_start.start_index, accepted.end_index, _name, _expression);
    }
    ...
    static if_statement = function() {
        ...
        return new IfStatement(_start.start_index, accepted.end_index, _condition, _statement, _alternate);
    }
    ...
    static do_statement = function() {
        ...
        return new DoStatement(_start.start_index, accepted.end_index, _body, _test);
    }
    ...
    static while_statement = function() {
        ...
        return new WhileStatement(_start.start_index, accepted.end_index, _body, _test);
    }
    ...
    static with_statement = function() {
        ...
        return new WithStatement(_start.start_index, accepted.end_index, _body, _expression);
    }
    ...
    static repeat_statement = function() {
        ...
        return new RepeatStatement(_start.start_index, accepted.end_index, _body, _expression);
    }
    ...
    static for_statement = function() {
        ...
        return new ForStatement(_start.start_index, accepted.end_index, _init, _test, _update, _body);
    }
    ...
    static switch_statement = function() {
        ...
        return new SwitchStatement(_start.start_index, accepted.end_index, _expression, _cases);
    }
    ...
    static switch_case = function() {
        if (accept(GmlTokenKind.CASE)) {
            ...
            var _statements = statement_list();
            return new SwitchCase(_start.start_index, accepted.end_index, _test, _statements);
        } else if (accept(GmlTokenKind.DEFAULT)) {
            var _start = accepted;
            expect(GmlTokenKind.COLON);
            var _statements = statement_list();
            return new SwitchCase(_start.start_index, accepted.end_index, undefined, _statements);
        } else {
            return undefined;
        }
    }
    ...
    static try_statement = function() {
        ...
        if (accept(GmlTokenKind.CATCH)) {
            ...
            var _body = expect_defined(statement());
            _catch = new CatchClause(_start.start_index, accepted.end_index, _identifier, _body);
        }
        ...
        return new TryStatement(_start.start_index, accepted.end_index, _try_body, _catch, _finally);
    }
    ...
    static continue_statement = function() {
        ...
        return new ContinueStatement(accepted.start_index, accepted.end_index);
    }
    ...
    static break_statement = function() {
        ...
        return new BreakStatement(accepted.start_index, accepted.end_index);
    }
    ...
    static exit_statement = function() {
        ...
        return new ExitStatement(accepted.start_index, accepted.end_index);
    }
    ...
    static return_statement = function() {
        ...
        return new ReturnStatement(_start.start_index, accepted.end_index, _expression);
    }
    ...
    static throw_statement = function() {
        ...
        var _expression = expression();
        return new ThrowStatement(_start.start_index, accepted.end_index, _expression);
    }
    ...
    static delete_statement = function() {
        ...
        var _expression = expression();
        return new DeleteStatement(_start.start_index, accepted.end_index, _expression);
    }
    ...
    static conditional_expression = function() {
        ...
        if (accept(GmlTokenKind.QUESTION_MARK)) {
            ...
            return new ConditionalExpression(_start.start_index, accepted.end_index, _when_true, _when_false);
        }
    ...
    static __handle_binary_expression = function(_token_kind_array, _next_func) {
        ...
        while (accept_any(_token_kind_array)) {
            ...
            _result = new BinaryExpression(_start.start_index, accepted.end_index, _operator, _result, _right_expr);
        }
    ...
    static bit_and_expression = function() {
        return __handle_binary_expression([GmlTokenKind.BIT_AND], null_coalescing_expression);
    }
    ...
    static additive_expression = function() {
        return __handle_binary_expression(__additive_operators, multiplicative_expression);
    }
    ...
    static unary_expression = function() {
        ...
        if (accept_any(__prefix_operators)) {
            ...
            return new UnaryExpression(_start.start_index, accepted.end_index, _operator, _primary_expression, true);
        }
    ...
    static primary_expression = function(_accept_unary_operators=true) {
        ...
        while (!hit_eof) {
            ...
            if (
                ...
                var _operator = accepted.text;
                _object = new UnaryExpression(_start.start_index, accepted.end_index, _operator, _object, false);
                break;
                ...
                _object = new MemberIndexExpression(_start.start_index, accepted.end_index, _object, _properties, _accessor);
            } else if (accept(GmlTokenKind.DOT)) {
                var _identifier = expect_defined(identifier());
                return new MemberDotExpression(_start.start_index, accepted.end_index, _object, _identifier);
            } else {
                var _arguments = argument_list();
                if (!is_undefined(_arguments)) {
                    _object = new CallExpression(_start.start_index, accepted.end_index, _object, _arguments);
                } else {
                    break;
                }
            }
    ...
    static primary_expression_start = function() {
        ...
        if (accept(GmlTokenKind.NEW)) {
            ...
            return new NewExpression(_start.start_index, accepted.end_index, _newable_expression);
        }
    ...
    static argument_list = function() {
        ...
        while (!hit_eof)
        {
            ...
            if (accept(GmlTokenKind.COMMA))
            {
                if (_previous_child_was_punctuator)
                {
                    array_push(_arguments, new UndefinedLiteral(_start.start_index, accepted.end_index));
                }
    ...
    static literal = function() {
        ...
        if (accept(GmlTokenKind.UNDEFINED)) {
            return new UndefinedLiteral(_start.start_index, accepted.end_index);
        } else if (accept(GmlTokenKind.INTEGER_LITERAL)) {
            return new IntegerLiteral(_start.start_index, accepted.end_index, real(accepted.text));
        } else if (accept(GmlTokenKind.DECIMAL_LITERAL)) {
            return new DecimalLiteral(_start.start_index, accepted.end_index, real(accepted.text));
        } else if (accept(GmlTokenKind.STRING_LITERAL)) {
            return new StringLiteral(_start.start_index, accepted.end_index, accepted.text);
        } else if (accept(GmlTokenKind.VERBATIM_STRING_LITERAL)) {
            return new VerbatimStringLiteral(_start.start_index, accepted.end_index, accepted.text);
        } else if (accept(GmlTokenKind.SIMPLE_TEMPLATE_STRING)) {
            var _text = string_copy(accepted.text, _start.start_index + 1, string_length(accepted.text) - 1);
            var _string_literal = new StringLiteral(_start.start_index + 2, accepted.end_index - 1, _text);
            return TemplateStringLiteral(_start.start_index, accepted.end_index, []);
        } else if (
            accept(GmlTokenKind.HEX_INTEGER_LITERAL)
            || accept(GmlTokenKind.BINARY_LITERAL)
        ) {
            return new BinaryLiteral(_start.start_index, accepted.end_index, real(accepted.text));
        } else if (accept(GmlTokenKind.BOOLEAN_LITERAL)) {
            return new BooleanLiteral(_start.start_index, accepted.end_index, bool(accepted.text));
        } else if (accept(GmlTokenKind.NOONE)) {
            return new NoOneLiteral(_start.start_index, accepted.end_index);
        }
    ...
    static array_literal = function() {
		...
		if (accept(GmlTokenKind.CLOSE_BRACKET)) {
			return new ArrayLiteral(_start.start_index, accepted.end_index, []);
		}
		...
		return new ArrayLiteral(_start.start_index, accepted.end_index, _elements);
    }
	...
	static struct_literal = function() {
		...
		if (accept(GmlTokenKind.CLOSE_BRACE)) {
			return new StructLiteral(_start.start_index, accepted.end_index, []);
		}
		...
		return new StructLiteral(_start.start_index, accepted.end_index, _properties);
	}
    ...
    static property_assignment = function() {
		...
		if (
			...
			_name = new Identifier(_start.start_index, accepted.end_index, accepted.text);
		} else if (accept(GmlTokenKind.STRING_LITERAL)) {
			_name = new StringLiteral(_start.start_index, accepted.end_index, accepted.text);
		} else {
			return undefined;
		}
		...
		return new StructProperty(_start.start_index, accepted.end_index, _name, _initializer);
    }
    ...
    static identifier = function() {
        if (accept(GmlTokenKind.IDENTIFIER) || accept(GmlTokenKind.CONSTRUCTOR)) {
            return new Identifier(accepted.start_index, accepted.end_index, accepted.text);
        } 
        return undefined;
    }
}
